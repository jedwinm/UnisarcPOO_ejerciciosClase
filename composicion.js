...
// Definición de la clase carro con composición de Motor
class carro {
    constructor(color, marca, modelo, numPuertas, motor) {
        ...
        this.motor = motor; // Composición con la clase Motor
    }
    ...
    // Método para arrancar el carro utilizando el motor
    arrancar() {
        this.motor.iniciar();
        console.log(`El carro ${this.marca} ${this.modelo} ha arrancado.`);
    }

    // Método para detener el carro utilizando el motor
    detener() {
        this.motor.detener();
...
// Creación de una instancia de Motor (parte de la composición)
const motorcarro = new Motor("Gasolina", 2000);

// Creación de una instancia de carro con composición de motor
